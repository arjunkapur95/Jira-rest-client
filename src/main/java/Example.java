...
public class Example {
    ...
    public static void main(String[] args) throws JiraException {
        ...
        JiraClient jira = new JiraClient("https://taldemonet3.atlassian.net", creds);

        try {
            /* Retrieve issue TEST-123 from JIRA. We'll get an exception if this fails. */
            final Issue issue = jira.getIssue("DEMO-2");
           ...
           // issue.addWatcher("robin");
            ...
            newIssue.link("DEMO-1", "Dependency");
            ...
            Issue.SearchResult sr1 = jira.searchIssues("project IN DEMO ORDER BY id");
            while (sr1.iterator().hasNext())
                System.out.println("Result: " + sr1.iterator().next());
